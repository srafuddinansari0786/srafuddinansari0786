...
```typescript
const srafuddinAnsari = {
  title: "Full Stack .NET Developer",
  currentRole: "Software Developer @ VRS Intelligent Innovative System Pvt. Ltd., Noida",
  stack: {
    languages: ["C#"],
    backend: ["ASP.NET", "ASP.NET Core MVC", "ASP.NET Core APIs", "Entity Framework", "Entity Framework Core"],
    frontend: ["HTML", "CSS", "jQuery", "AJAX", "Bootstrap", "Angular"],
    database: ["SQL Server", "MySQL"],
    tools: ["Git", "GitHub", "GitLab", "Swagger", "Postman"],
    hosting: ["Windows Application Server Hosting", "Public / Global Hosting"]
  },
  launchedProjects: [
    "ATMS - Advance Traffic Management System (NHAI)",
    "Inventory Management System",
    "Employee Attendance Management System"
  ],
  certifications: ["DotNet Full Stack Development - A&N IT Services"],
  status: "Building enterprise-grade .NET solutions",
  openTo: ["Full Stack .NET roles", "Backend / API development", "Collaborations"]
};
```
...
|---|---|
| Language | C# |
| Backend | ASP.NET Core MVC, Razor Pages, RESTful APIs, Web Services |
| ORM | Entity Framework Core |
| Database | SQL Server |
| Frontend | jQuery, AJAX, JavaScript, Bootstrap |

**[Code](https://github.com/srafuddinansari0786/atms-advance-traffic-management-system)**
...
|---|---|
| Language | C# |
| Backend | ASP.NET Core MVC, Razor Pages, RESTful APIs |
| ORM | Entity Framework Core |
| Database | SQL Server |
| Frontend | jQuery, JavaScript, Bootstrap |

**[Code](https://github.com/srafuddinansari0786/inventory-management-system)**
...
**[Code](https://github.com/srafuddinansari0786/employee-attendance-management-system)**
...
**Frontend**
<br/>
<img src="https://skillicons.dev/icons?i=html,css,jquery,bootstrap,angular,js" />
...
**Dev Tools**
<br/>
<img src="https://skillicons.dev/icons?i=git,github,gitlab,swagger,postman" />
...
<a href="https://www.linkedin.com/in/srafuddin-ansari-0a2950255" target="_blank">
